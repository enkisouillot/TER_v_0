...
begin
  rw [has_deriv_at] at hf,
  rw [has_deriv_at_filter] at hf,
  rw [has_fderiv_at],
  rw realify,
  rw multiplication, simp,
  convert has_fderiv_at_filter.comp _ _ _ _,
  sorry
end

lemma cauchy_riemann_ouvert (f : ℂ → ℂ)(f' : ℂ)(ho : is_open Ω)(hf : has_deriv_within_at f f' Ω z) : has_fderiv_within_at (realify f) (multiplication f') (equiv_real_prod '' Ω) (equiv_real_prod.to_fun z) :=
begin
  sorry
end
